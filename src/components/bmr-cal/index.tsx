...
export default function IdealBodyWeight() {
  ...
  return (
    <div className={tw(`container`)}>ccc
      <form onSubmit={handleSubmit(onSubmit)} className={tw`${style.twForm}`} >
        ...
        <br />
        <label className={tw`${style.twLabel}`}>Current weight</label>
        <br />
        ...
        <br />
        <label className={tw`${style.twLabel}`}>Exercise Mode</label>
        <br />
        <select {...register("activity", { required: true })} className={tw`${style.twInputText}`}>
      <option value={1.2} defaultValue={1.2} >Sedentary</option>
      <option value={1.375}>Light</option>
      <option value={1.465}>Moderate</option>
      <option value={1.55}>Very Active</option>
      <option value={1.725}>Extreme</option>
      </select>
